	    ...
	    <div class="panel-body">
			...
			<form class="form-horizontal" action="<?php echo site_url('mahasiswa/eksekusi_edit'); ?>" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="detail" name="detail" value="<?php echo $a->detail;?>">
					</div>
				</div>
				<div class="form-group">
					...
					<tbody>
					  ...
					  <tr>
						...
						<td class="text-center">
							<img src="<?php echo base_url('uploads/'.$list->photo) ?>" style="width:100px; height:100px">
						</td>
						<td class="text-center"><?php echo $list->detail;?></td>
